...
void findObjects(GBufferedImage* inputImg){
    ...
    for(int y=0; y<imgHeight-1;y++){
        for(int x=0; x<imgWidth-1;x++){
            if(isSilhouetteColor(userImg->getRGB(x, y))){
